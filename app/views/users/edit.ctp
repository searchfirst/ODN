...
<form action="<?php echo $html->url('/customers/edit/'.$html->tagValue('Customer.id'))?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
<fieldset> 
...
<?php echo $form->input('Customer.customer_id',array('options'=>$customer_list,'empty'=>true,'selected'=>$html->tagValue('Customer.customer_id'),'label'=>'Customer Of','error'=>"Your customer can't be a customer of itself."))?> 
</fieldset>
<?php endif;?>
